        ...
        <div class="wrapper-box" style="background-color: maroon;">
            ...
            <nav class="side-nav">
                <ul>
                    ...
                    <li>
                        <a href="<?= base_url('categories/kain_tenun') ?>" class="side-menu side-menu">
                            <div class="side-menu__icon"> <i data-lucide="home"></i> </div>
                            <div class="side-menu__title">
                                Sepu
                                <div class="side-menu__sub-icon transform rotate-180"> </div>
                    ...
                    <li>
                        <a href="<?= base_url('categories/tikar') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Tikar </div>
                        </a>
                    </li>
                    <li>
                        <a href="<?= base_url('categories/miniatur') ?>" class="side-menu">
                            <div class="side-menu__icon"> <i data-lucide="file-text"></i> </div>
                            <div class="side-menu__title"> Kapipe</div>
                        </a>
                    </li>
