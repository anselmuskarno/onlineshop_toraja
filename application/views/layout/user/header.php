...
<head>
    ...
    <title><?= $title ?> | Denpina Shop</title>
    <!-- BEGIN: CSS Assets-->
...
<body class="main" style="background-color: maroon;">
    <!-- BEGIN: Mobile Menu -->
    <div class="mobile-menu md:hidden" style="background-color: maroon;">
        <div class="mobile-menu-bar" style="background-color: maroon;">
            <a href="" class="flex mr-auto">
                <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/admin/dist/images/logo.svg">
            </a>
            <a href="javascript:;" class="mobile-menu-toggler"> <i data-lucide="bar-chart-2" class="w-8 h-8 text-white transform -rotate-90"></i> </a>
        </div>
        <div class="scrollable" style="background-color: maroon;">
    ...
    <!-- END: Mobile Menu -->
    <!-- BEGIN: Top Bar -->
    <div class="top-bar-boxed h-[70px] z-[51] relative border-b border-white/[0.08] mt-12 md:-mt-5 -mx-3 sm:-mx-8 px-3 sm:px-8 md:pt-0 mb-12" style="background-color: maroon;">
        <div class="h-full flex items-center" style="background-color: maroon;">
            <!-- BEGIN: Logo -->
            <a href="" class="-intro-x hidden md:flex">
                <img alt="Midone - HTML Admin Template" class="w-6" src="<?= site_url('asset') ?>/admin/dist/images/logo.svg">
                <span class="text-white text-lg ml-3"> Denpina Shop </span>
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
            ...
            <div class="intro-x dropdown mr-4 sm:mr-6">
                ...
                <div class="notification-content pt-2 dropdown-menu">
                    <div class="notification-content__box dropdown-content">
                        <div class="notification-content__title"> <?php $keranjang = 'Keranjang Belanja : ' . $this->cart->total_items() . ' items ' ?>&nbsp; <?php echo $keranjang ?></div>
                        ...
                        <br>
                        <hr>
                        <button class="btn btn-sm btn-rounded-primary mt-4"><span class="text-uppercase"><a href="<?= site_url('dashboard/detail_cart') ?>">DETAIL KERANJANG</a></span></button>
                    </div>
                </div>
            </div>
            <!-- END: Notifications -->
    ...
    <div class="wrapper">
        <div class="wrapper-box" style="background-color: maroon;">
            <!-- BEGIN: Side Menu -->
            <nav class="side-nav">
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="<?= base_url('bill') ?>" class="side-menu">
                            ...
                            <div class="side-menu__title"> Riwayat Tagihan </div>
                        </a>
                    </li>
