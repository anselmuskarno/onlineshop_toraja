        ...
        <div class="col-span-12 2xl:col-span-9">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-6 -mb-6 intro-y">
                    <div class="alert alert-dismissible show box  text-white flex items-center mb-6" role="alert" style="background-color: maroon;">
                    ...
                    <?php foreach ($bill as $row) : ?>
                        <div class="intro-y">
                            <div class="box px-4 py-4 mb-3 flex items-center zoom-in">
                                ...
                                <div class="py-1 px-2 rounded-full text-xs bg-danger text-white cursor-pointer font-medium"></div>
                            </div>
                        </div>
                    <?php endforeach; ?>
