   <div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?= site_url('admin/invoice/pdf/'.$invoice->order_id) ?>" class=""></a>
            ...
            <div class="box p-5 rounded-md">
                ...
                <div class="box p-5 rounded-md mt-5">
                    <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5 mb-5">
                        ...
                        <a href="" class="flex items-center ml-auto text-primary"> <i data-lucide="map-pin" class="w-4 h-4 mr-2"></i>  </a>
                    </div>
                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th class="whitespace-nowrap text-right">Harga per Unit</th>
