                                    ...
                                    <center>
                                        <?php if ($row->status == "0") { ?>
                                            <div class="flex justify-center items-center">
                                                <a class="flex items-center text-primary whitespace-nowrap" href="<?= site_url('admin/invoice/confirm/' . $row->order_id) ?>"> <i data-lucide="arrow-left-right" class="w-4 h-4 mr-1"></i> Ganti Status </a>
                                            </div>
                                        <?php } else if ($row->status == "1") { ?>
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="p-5 text-center">
                            ...
                            <div class="text-3xl mt-5">Anda Yaki?</div>
                            <div class="text-slate-500 mt-2">
                                Apa anda benar-benar yakin untuk menghapus data ini?
                                <br>
