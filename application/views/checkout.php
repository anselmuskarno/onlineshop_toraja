<div class="content">
    ...
    <div class=" pos intro-y grid grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="alert alert-primary show mb-2" role="alert">Jumlah Transaksi Yang Harus Dibayar : <b>Rp. <?= number_format($totalBayar, 0, ',', '.') ?>.000,-</b> </div>
                        ...
                        <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby="content-tab">
                            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
                                ...
                                <div class="mt-5">
                                    ...
                                    <div class="mb-5">
                                        <label for="post-form-7" class="form-label">No.HP <small class="text-danger">*</small></label>
                                        <input type="text" id="mobile_phone" name="mobile_phone" class="form-control" placeholder="No. HP anda" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="ticket" class="tab-pane active" role="tabpanel" aria-labelledby="ticket-tab">
                <div class="box p-2 mt-5">
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        ...
                        <div class="ml-auto font-medium">No.Rek.xxxxxxx / Nama-xxxxx</div>
                    </a>
                    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-item-modal" class="flex items-center p-3 cursor-pointer transition duration-300 ease-in-out bg-white dark:bg-darkmode-600 hover:bg-slate-100 dark:hover:bg-darkmode-400 rounded-md">
                        <div class="max-w-[50%] truncate mr-1">
                ...
                <div class="box p-5 mt-5">
                    <div class="flex">
                        ...
                        <div class="font-medium">Rp. <?= number_format($grand_total, 0, ',', '.') ?>.000</div>
                    </div>
                    <div class="flex">
                        <div class="mr-auto">Ongkir</div>
                        <div class="font-medium">Rp. <?= number_format($diskon, 0, ',', '.') ?>.000</div>
                    </div>
                    <!--                    <div class="flex mt-4">-->
                    ...
                    <div class="flex mt-4 pt-4 border-t border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <div class="font-medium text-base"><strong>Rp. <?= number_format($totalBayar, 0, ',', '.') ?>.000,-</strong></div>
                    </div>
                </div>
            </div>
        </div>
