  <div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <a href="<?= site_url('bill')?>" class="btn btn-primary shadow-md mr-2">Riwayat Tagihan</a>
    ...
    <div class="intro-y box overflow-hidden mt-5">
        <div class="border-b border-slate-200/60 dark:border-darkmode-400 text-center sm:text-left">
            <div class="px-5 py-10 sm:px-20 sm:py-20">
                <div class="text-primary font-semibold text-3xl">BUKTI PEMESANAN</div>
                <div class="mt-2"> Receipt <span class="font-medium">#<?= $invoice->order_id ?></span> </div>
                <div class="mt-1"><?= $invoice->transaction_time ?></div>
            </div>
            <div class="flex flex-col lg:flex-row px-5 sm:px-20 pt-0 pb-0 sm:pb-20">
                <div>
                ...
                <div class="lg:text-right mt-5 lg:mt-0 lg:ml-auto">
                    <div class="text-base text-slate-500"></div>
                    <div class="text-lg font-medium text-primary mt-2"></div>
                    <div class="mt-1"></div>
                </div>
            </div>
        </div>
        <div class="px-5 sm:px-16 py-3 sm:py-10">
